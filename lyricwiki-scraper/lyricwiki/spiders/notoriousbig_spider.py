...
class LyricWikiSpider(CrawlSpider):
    name = "biggie"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/The_Notorious_B.I.G.",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/The_Notorious_B.I.G.:.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
