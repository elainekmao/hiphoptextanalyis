...
class LyricWikiSpider(CrawlSpider):
    name = "sugarhill"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/The_Sugarhill_Gang",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/The_Sugarhill_Gang:.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
