...
class LyricWikiSpider(CrawlSpider):
    name = "krs"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/KRS-One",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/KRS-One:.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
