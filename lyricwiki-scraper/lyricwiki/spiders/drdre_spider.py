...
class LyricWikiSpider(CrawlSpider):
    name = "drdre"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/Dr_Dre",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/Dr._Dre:.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
