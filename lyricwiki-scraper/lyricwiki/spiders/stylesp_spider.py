...
class LyricWikiSpider(CrawlSpider):
    name = "stylesp"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/Styles_P",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/Styles_P:.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
