...
class LyricWikiSpider(CrawlSpider):
    name = "bigkrit"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/Big_K.R.I.T.",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/Big_K.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
