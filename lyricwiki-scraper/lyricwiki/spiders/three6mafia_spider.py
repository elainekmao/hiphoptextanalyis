...
class LyricWikiSpider(CrawlSpider):
    name = "three6mafia"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/Three_6_Mafia",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/Three_6_Mafia:.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
