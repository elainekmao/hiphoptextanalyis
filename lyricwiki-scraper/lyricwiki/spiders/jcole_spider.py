...
class LyricWikiSpider(CrawlSpider):
    name = "jcole"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/J._Cole",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/J._Cole:.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
