...
class LyricWikiSpider(CrawlSpider):
    name = "jazzyjeff"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/DJ_Jazzy_Jeff_%26_The_Fresh_Prince",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/DJ_Jazzy_Jeff_.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
