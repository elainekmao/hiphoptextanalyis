...
class LyricWikiSpider(CrawlSpider):
    name = "eazy-e"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/Eazy-E",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/Eazy-E:.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
