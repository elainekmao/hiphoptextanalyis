...
class LyricWikiSpider(CrawlSpider):
    name = "soulsofmischief"                                         #CHANGE NAME
    allowed_domains = ["lyrics.wikia.com"]
    start_urls = [
        "http://lyrics.wikia.com/Souls_Of_Mischief",     #CHANGE URL
    ]
    rules = (                                               #CHANGE REGEX
        Rule(SgmlLinkExtractor(allow=('/Souls_Of_Mischief:.*',),restrict_xpaths=('//ol/li',)), callback='parse_item', follow=True),
        )
